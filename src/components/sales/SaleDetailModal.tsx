...
import { CalendarDays, User, CreditCard, FileText, DollarSign } from "lucide-react";
            ...
            <CardContent className="p-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-mono">{sale.reservation_number}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Vendeur:</span>
                  <Badge variant="outline">{sale.employee_name}</Badge>
                </div>
                <div className="flex justify-between">
